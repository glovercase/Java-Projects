...
/* Code for COMP 102 Assignment Makeup1
 * Name: pondy
 */
...
public class CartoonFigure {
    ...
    */
    ...
    public void speak(String words) {
        ...
        UI.eraseRect(boxX, boxY, this.wordsWidth, this.wordsHeight,false);
        UI.drawRect(boxX, boxY, this.wordsWidth, this.wordsHeight,false);
    ...
    public void think(String words) {
        ...
        UI.eraseOval(bubbleX, bubbleY, this.wordsWidth, this.wordsHeight,false);
        UI.drawOval(bubbleX, bubbleY, this.wordsWidth, this.wordsHeight,false);
        UI.drawString(words, bubbleX + 12, bubbleY + this.wordsHeight/2 + 3,false);

        UI.drawOval(circleX, circleY, 10, 10);

        UI.sleep(1000);

        UI.eraseRect(bubbleX, bubbleY, this.wordsWidth+1, this.wordsHeight+1, false);
    ...
    private void erase() {
        UI.eraseRect(this.figureX, this.figureY, this.figureWidth+1, this.figureHeight+1, false);
    }
    ...
    private void draw(){
        ...
        UI.drawImage(fname, this.figureX, this.figureY, this.figureWidth, this.figureHeight, false);
        UI.repaintGraphics();
        UI.sleep(500);
    }

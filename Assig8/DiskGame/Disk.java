 ...
 *   - overlapping(otherDisk) Whether this disk overlaps the other disk.
 *   - withinRange(otherDisk) Whether this disk is within the damage range of the other disk.
 */
public class Disk {
    ...
    /**
     * Constructor: initialise the  new disk.
     */
    ...
    //Copied code from balloon game and adapted
     ...
     */
    public boolean overlapping(Disk other) {
     ...
     */
    public boolean withinRange(Disk other) {
        double dx = other.centerX - this.centerX;
        double dy = other.centerY - this.centerY;
